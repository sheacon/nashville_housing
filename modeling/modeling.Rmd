...
- In the Normal QQ-plot, we're seeing decent normality in the residuals but evidence of some non-linear characteristics not captured by our model.
...
The mean absolute error for predicted price is \$53k or 15% of true home price. The median figures are \$35k and 11%.
